...
router.get(
  ...
  authMiddleware,
  roleMiddleware(['admin', 'user']),
  advisoryController.advisoryByID
);
...
router.delete(
  ...
  authMiddleware,
  roleMiddleware(['admin']),
  advisoryController.deleteAdvisoryByID
);
...
router.patch(
  ...
  authMiddleware,
  roleMiddleware(['admin']),
  advisoryController.patchAdvisoryByID
);
